...
parser.add_argument(
    ...
    dest="providers",
    type=str,
    help="Comma separated list of providers to get reports from. Options are: gcp, github, heroku",
    default="",
)
parser.add_argument(
    "-c",
    "--compact",
    dest="compact",
    help="Show compact summary instead of verbose output. Ignores incident details and header.",
    action="store_true",
)
